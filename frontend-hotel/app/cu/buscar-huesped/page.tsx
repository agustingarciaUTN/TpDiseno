...
const steps = [
  "Ingresar criterios: apellido/nombres, tipo y número de documento",
  "Listar coincidencias y seleccionar huésped",
  "Continuar a modificar datos o dar de alta si no existe",
  "Enter o click ejecutan las acciones (Shift+Tab retrocede)",
];
