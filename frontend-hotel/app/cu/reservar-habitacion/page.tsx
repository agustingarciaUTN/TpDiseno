...
const steps = [
  "Ingresar fechas (desde/hasta) y mostrar disponibilidad",
  "Seleccionar una o varias habitaciones y ver el resumen",
  "Validar condiciones especiales y estado 'Disponible'",
  "Confirmar reserva a nombre de un huésped" ,
];
    ...
    <div className="min-h-screen bg-slate-950 text-slate-50">
      <main className="mx-auto flex max-w-4xl flex-col gap-6 px-6 py-12">
        <header className="space-y-3">
          <p className="text-xs uppercase tracking-[0.25em] text-amber-200/80">CU04</p>
          <h1 className="text-3xl font-semibold">Reservar habitación</h1>
          <p className="text-sm text-slate-200/80">
            Reservar habitaciones para un eventual huésped en un rango de fechas. Incluye
            mostrar disponibilidad y pintar el estado de cada selección.
          </p>
        </header>
