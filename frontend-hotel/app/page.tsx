...
import { Hotel, Search, Edit, UserPlus, XCircle, FileText, UserCheck, UserMinus } from "lucide-react"
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
            <main className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
                <div className="mb-12 text-center">
                    ...
                    <p className="text-lg text-slate-600 dark:text-slate-400">Gestión de huéspedes y reservas</p>
                </div>
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <Card className="group p-6 transition-all hover:shadow-xl">
                        ...
                        <h3 className="mb-2 text-xl font-semibold text-slate-900 dark:text-slate-50">Modificar Responsable de Pago</h3>
                        <p className="mb-4 text-sm text-slate-600 dark:text-slate-400">
                            Modificar datos personales de los huéspedes.
                        </p>
                        <Button asChild className="w-full">
                            <Link href="/modificar-responsable-pago">Ir a búsqueda</Link>
                        </Button>
                    </Card>
                <Card className="group p-6 transition-all hover:shadow-xl">
